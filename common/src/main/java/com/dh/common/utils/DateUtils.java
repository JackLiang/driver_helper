...
public class DateUtils {
	 ...
	 * 日期+时间格式
	 */
	public static final String DATA_DATE_TIME_FORMAT = "yyyy-MM-dd HH:mm:ss";
	 ...
	 * @throws java.text.ParseException
	 */
	public static Date stringToDate(String strTime, String formatType) throws java.text.ParseException {
