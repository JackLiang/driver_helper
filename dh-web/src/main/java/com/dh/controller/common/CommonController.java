...
//	private SystemPropertyService systemPropertyService;
	...
	public Object uploadPicUrl(String user_id, int type, MultipartFile file) {
		...
		try {
			...
			String tempname = new SimpleDateFormat("yyyyMMddHHmmssSSS").format(new Date()) + UUID.randomUUID().toString().substring(0, 8) + "."
					+ imgType;
...
//		String version = systemPropertyService.get("android_app_version").getValue();
//		String url = systemPropertyService.get("android_app_share_url").getValue();
//		
